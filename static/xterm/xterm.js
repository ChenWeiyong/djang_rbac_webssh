(function (f) {
    ...
    return (function () {
        ...
        1: [function (require, module, exports) {
            ...
            var AccessibilityManager = (function (_super) {
                ...
                function AccessibilityManager(_terminal) {
                    ...
                    _this.register(_this._terminal.addDisposableListener('resize', function (data) {
                        return _this._onResize(data.rows);
                    }));
                    _this.register(_this._terminal.addDisposableListener('refresh', function (data) {
                        return _this._refreshRows(data.start, data.end);
                    }));
                    _this.register(_this._terminal.addDisposableListener('scroll', function (data) {
                    ...
                    _this.register(_this._terminal.addDisposableListener('linefeed', function () {
                    ...
                    _this.register(_this._terminal.addDisposableListener('key', function (keyChar) {
                        return _this._onKey(keyChar);
                    }));
                    _this.register(_this._terminal.addDisposableListener('blur', function () {
                        return _this._clearLiveRegion();
                    }));
                    _this.register(_this._terminal.addDisposableListener('dprchange', function () {
                        return _this._refreshRowsDimensions();
                    }));
                    _this.register(_this._terminal.renderer.addDisposableListener('resize', function () {
                        return _this._refreshRowsDimensions();
                    }));
            ...
            "./Strings": 13,
            "./common/Lifecycle": 18,
            "./shared/utils/Browser": 46,
            "./ui/Lifecycle": 48,
            "./ui/RenderDebouncer": 50
        }],
        ...
        }, {"./BufferLine": 3, "./common/CircularList": 16, "./common/EventEmitter": 17}],
        ...
        }, {"./Buffer": 2, "./common/EventEmitter": 17}],
        ...
        8: [function (require, module, exports) {
            ...
            "./common/Lifecycle": 18,
            "./common/data/EscapeSequences": 19,
            "./core/data/Charsets": 20
        }],
        ...
        }, {"./Buffer": 2, "./CharWidth": 5, "./common/EventEmitter": 17, "./ui/MouseZoneManager": 49}],
        10: [function (require, module, exports) {
            ...
            "./Buffer": 2,
            "./SelectionModel": 11,
            "./common/EventEmitter": 17,
            "./handlers/AltClickHandler": 22,
            "./shared/utils/Browser": 46,
            "./utils/MouseHelper": 53
        }],
        ...
        14: [function (require, module, exports) {
            ...
            var Terminal = (function (_super) {
                ...
                Terminal.prototype._bindKeys = function () {
                    ...
                    this.register(this.addDisposableListener('refresh', function (data) {
                        return _this._queueLinkification(data.start, data.end);
                    }));
                };
                Terminal.prototype.open = function (parent) {
                    ...
                    this._screenDprMonitor.setListener(function () {
                        return _this.emit('dprchange', window.devicePixelRatio);
                    });
                    ...
                    this.register(this.addDisposableListener('resize', function () {
                        return _this.renderer.onResize(_this.cols, _this.rows);
                    }));
                    ...
                    this.register(this.addDisposableListener('dprchange', function () {
                        return _this.renderer.onWindowResize(window.devicePixelRatio);
                    }));
                    this.register(Lifecycle_1.addDisposableDomListener(window, 'resize', function () {
                        return _this.renderer.onWindowResize(window.devicePixelRatio);
                    }));
                    this.register(this.charMeasure.addDisposableListener('charsizechanged', function () {
                        return _this.renderer.onCharSizeChanged();
                    }));
                    this.register(this.renderer.addDisposableListener('resize', function (dimensions) {
                    ...
                    this.register(this.selectionManager.addDisposableListener('refresh', function (data) {
                        return _this.renderer.onSelectionChanged(data.start, data.end, data.columnSelectMode);
                    }));
            ...
            "./common/EventEmitter": 17,
            "./common/data/EscapeSequences": 19,
            "./core/input/Keyboard": 21,
            "./handlers/Clipboard": 23,
            "./renderer/ColorManager": 27,
            "./renderer/Renderer": 31,
            "./renderer/atlas/CharAtlasCache": 35,
            "./renderer/dom/DomRenderer": 42,
            "./shared/utils/Browser": 46,
            "./ui/CharMeasure": 47,
            "./ui/Lifecycle": 48,
            "./ui/MouseZoneManager": 49,
            "./ui/ScreenDprMonitor": 51,
            "./utils/Clone": 52,
            "./utils/MouseHelper": 53
        }],
        ...
        }, {"./common/Lifecycle": 18, "./ui/Lifecycle": 48}],
        ...
        }, {"../Buffer": 2, "./atlas/CharAtlasCache": 35, "./atlas/Types": 41}],
        ...
        30: [function (require, module, exports) {
            ...
            var LinkRenderLayer = (function (_super) {
                ...
                function LinkRenderLayer(container, zIndex, colors, terminal) {
                    ...
                    _this._state = null;
                    terminal.linkifier.on("linkhover", function (e) {
                        return _this._onLinkHover(e);
                    });
                    terminal.linkifier.on("linkleave", function (e) {
        ...
        }, {"./BaseRenderLayer": 25, "./atlas/Types": 41}],
        31: [function (require, module, exports) {
            ...
            "../common/EventEmitter": 17,
            "../renderer/CharacterJoinerRegistry": 26,
            "../ui/RenderDebouncer": 50,
            "../ui/ScreenDprMonitor": 51,
            "./ColorManager": 27,
            "./CursorRenderLayer": 28,
            "./LinkRenderLayer": 30,
            "./SelectionRenderLayer": 32,
            "./TextRenderLayer": 33
        }],
        ...
        }, {"../Buffer": 2, "./BaseRenderLayer": 25, "./GridCache": 29, "./atlas/Types": 41}],
        ...
        }, {"./CharAtlasUtils": 36, "./DynamicCharAtlas": 37, "./NoneCharAtlas": 39, "./StaticCharAtlas": 40}],
        ...
        37: [function (require, module, exports) {
            ...
            "../../shared/atlas/CharAtlasGenerator": 44,
            "../../shared/utils/Browser": 46,
            "../ColorManager": 27,
            "./BaseCharAtlas": 34,
            "./LRUMap": 38,
        ...
        42: [function (require, module, exports) {
            ...
            var DomRenderer = (function (_super) {
                ...
                function DomRenderer(_terminal, theme) {
                    ...
                    _this._terminal.linkifier.on("linkhover", function (e) {
                        return _this._onLinkHover(e);
                    });
                    _this._terminal.linkifier.on("linkleave", function (e) {
                        return _this._onLinkLeave(e);
                    });
                    return _this;
                }
        ...
        }, {"../common/Lifecycle": 18, "./Lifecycle": 48}],
